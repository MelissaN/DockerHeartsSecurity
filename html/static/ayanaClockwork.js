document.addEventListener("DOMContentLoaded", function(event) {
   ...
   this.pageY = this.canvas.getBoundingClientRect().top + this.initFocusY + 10;
	...
	var botX = ayana.botX;
	if (botX > (1/12) * a) loc = 2;
	if (botX > (2/12) * a) loc = 3;
	if (botX > (3/12) * a) loc = 4;
	if (botX > (4/12) * a) loc = 5;
	if (botX > (5/12) * a) loc = 6;
	if (botX > (6/12) * a) loc = 7;
	if (botX > (7/12) * a) loc = 8;
	if (botX > (8/12) * a) loc = 9;
	if (botX > (9/12) * a) loc = 10;
	if (botX > (10/12) * a) loc = 11;
	if (botX > (11/12) * a) loc = 12;
